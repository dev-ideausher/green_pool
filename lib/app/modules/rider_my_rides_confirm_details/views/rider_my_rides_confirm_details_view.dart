...
class RiderMyRidesConfirmDetailsView
  ...
  Widget build(BuildContext context) {
    final otherPrefs = controller
        .riderConfirmRequestModel.driverRideDetails?.preferences?.other;
    return Scaffold(
                              ...
                              Text.rich(
                                TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          '${LocaleKeys.app_dollar.tr} ${controller.riderConfirmRequestModel.price}',
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    "${DateTimeUtils.getDateFormat(controller.riderConfirmRequestModel.driverRideDetails?.time ?? "")}  ${DateTimeUtils.convertUtcToLocal(controller.riderConfirmRequestModel.driverRideDetails?.time ?? "")}",
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${LocaleKeys.app_inA.tr} ${controller.riderConfirmRequestModel.driverRideDetails?.createdAt.toString().split("-")[0]}',
                      style:
                          TextStyleUtil.k14Regular(color: ColorUtil.kBlack03),
                    ),
                  ],
