        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'in ${controller.riderConfirmRequestModel.value.data?[controller.index]?.driverRideDetails?[0]?.createdAt.toString().split("-")[0]}',
                      style:
                          TextStyleUtil.k14Regular(color: ColorUtil.kBlack03),
                    ),
                  ],
            ...
            controller.riderConfirmRequestModel.value.data?[controller.index]
                        ?.driverRideDetails?[0]?.preferences?.other?.BabySeat ==
                    true
                ? Amenities(
                        toggleSwitch: false,
                        text: "Baby Seats",
