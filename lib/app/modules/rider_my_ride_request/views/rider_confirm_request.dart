              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                      bottom:
                          BorderSide(color: ColorUtil.kNeutral7, width: 2.kh),
                    ),
                  ),
                  child: Column(
                    children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${controller.riderConfirmRequestModel.value.data?[index]?.distance} km away",
                                        style: TextStyleUtil.k12Regular(
                                            color: ColorUtil.kBlack02),
                                      ),
                                    ],
                      ...
                      Row(
                        ...
                        children: [
                          GreenPoolButton(
                            ...
                            label: 'Accept',
                            onPressed: () async {
                              await controller.confirmRideByRiderAPI(index);
