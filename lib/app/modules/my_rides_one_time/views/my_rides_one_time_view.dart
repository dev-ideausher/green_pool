                                    ...
                                    itemBuilder: (context, index) {
                                      if (controller.myRidesModelData[index]?.driverId != null) {
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    controller.myRidesModelData[index]?.time == ""
                                                        ? Row(
                                                            children: [
                                                              ...
                                                              Text(
                                                                // '07 November 2023',
                                                                controller.myRidesModelData[index]?.date?.split('T')[0] ?? "",
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        itemCount:
                                                            controller.myRidesModelData[index]?.postsInfo?.length == 0 ? 4 : controller.myRidesModelData[index]?.postsInfo?.length,
                                                        reverse: true,
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: ClipOval(
                                                              child: SizedBox.fromSize(
                                                                ...
                                                                child: controller.myRidesModelData[index]?.postsInfo?.length == 0
                                                                    ? Image.asset(
                                                ...
                                                OriginToDestination(
                                                  origin: controller.myRidesModelData[index]?.origin?.name ?? 'Origin',
                                                  destination: controller.myRidesModelData[index]?.destination?.name ?? 'Destination',
                                                ).paddingOnly(bottom: 8.kh),
                                                Container(
                                                  width: 100.w,
                                                  height: 1.kh,
                                                ...
                                                Obx(
                                                  () => controller.myRidesModelData[index]?.isCancelled == true
                                                      ...
                                                      : controller.myRidesModelData[index]?.date == "" || controller.myRidesModelData[index]?.date == null
                                                          ? Row(
                                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                              children: [
                                                                GreenPoolButton(
                                        ...
                                        return
                                            //---------------- for rider tile ------------------//
                                            GestureDetector(
                                          onTap: () => controller.riderPagePageOpen(controller.myRidesModelData[index]!),
                                          child: Container(
                                            padding: EdgeInsets.all(16.kh),
                                            decoration: BoxDecoration(
                                              color: ColorUtil.kWhiteColor,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                OriginToDestination(
                                                        origin: "${controller.myRidesModelData[index]?.origin?.name}",
                                                        destination: "${controller.myRidesModelData[index]?.destination?.name}")
                                                    .paddingOnly(bottom: 8.kh),
                                                    ...
                                                    : Row(
                                                        ...
                                                        children: [
                                                          GreenPoolButton(
                                                            ...
                                                            onPressed: () {
                                                              controller.riderPagePageOpen(controller.myRidesModelData[index]!);
                                                            },
                                                            label: 'View Details',
                                                            fontSize: 14.kh,
                                                          ...
                                                          GreenPoolButton(
                                                            ...
                                                            padding: EdgeInsets.all(0.kh),
                                                            onPressed: () {
                                                              controller.riderCancelRideAPI(controller.myRidesModelData[index]!);
                                                            },
                                                            isBorder: true,
                                                            label: 'Cancel Ride',
                                                            fontSize: 14.kh,
