    ...
    return Obx(
      () => controller.sendRequestModel.value.data == null
          ...
          : controller.mapViewType.value
              ...
              : ListView.builder(
                  itemCount: controller.sendRequestModel.value.data?.length,
                              ...
                              Container(
                                ...
                                child: ClipOval(
                                  child: SizedBox.fromSize(
                                      ...
                                      child: Image(
                                          image: NetworkImage(
                                              "${controller.sendRequestModel.value.data![index]!.riderDetails![0]!.idPic?.url}"))),
                                ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            '2.1 km away',
                                            // '${controller.sendRequestModel.value.data![index]?.minStopDestinationDistance} km away',
                                            style: TextStyleUtil.k12Regular(
                                                color: ColorUtil.kBlack02),
                                          ),
                                        ],
                          ...
                          Row(
                            ...
                            children: [
                              GreenPoolButton(
                                ...
                                label: 'Request',
                                onPressed: () async {
                                  await controller.sendRiderRequestAPI(index);
