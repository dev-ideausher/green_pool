      ...
      appBar: GreenPoolAppBar(
        ...
        actions: [
          GestureDetector(
            ...
            child: SvgPicture.asset(ImageConstant.svgIconFilter).paddingOnly(right: 16.kw),
          ),
        ],
      ),
                    ...
                    children: [
                      Expanded(
                        child: ListView.builder(
                            itemCount: controller.matchingRidesModel.value.data?.length,
                            itemBuilder: (context, index) {
                              return (controller.matchingRidesModel.value.data![index]?.driverDetails?.isEmpty??true)?const SizedBox():GestureDetector(
                                onTap: () {
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                              ...
                                              Center(
                                                child: ClipRRect(
                                                    ...
                                                    child: CommonImageView(
                                                        height: 64.kh,
                                                        width: 64.kw,
                                                        url: "${controller.matchingRidesModel.value.data![index]?.driverDetails![0]?.profilePic?.url}")),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      Text(
                                                        // '0.0',
                                                        controller.matchingRidesModel.value.data?[index]?.driverDetails?[0]?.rating.toString() ?? '0.0',
                                                    ...
                                                    Text.rich(
                                                      TextSpan(
                                                        children: [
                                                          TextSpan(
                                                            // text: '\$3.50',
                                                            text: "\$ ${controller.matchingRidesModel.value.data![index]?.price}",
                                      ...
                                      OriginToDestination(
                                        origin: "${controller.matchingRidesModel.value.data![index]?.origin?.name}",
                                        destination: "${controller.matchingRidesModel.value.data![index]?.destination?.name}",
