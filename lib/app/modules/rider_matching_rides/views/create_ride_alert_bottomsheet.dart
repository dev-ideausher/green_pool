  ...
  Widget build(BuildContext context) {
    return Container(
                    ...
                    child: Column(
                      children: [
                        Text(
                          LocaleKeys.app_requestAlertCreatedSuccessfully.tr,
                        ...
                        Text(
                          LocaleKeys.app_rideAlertCreatedSuccessfully.tr,
                          textAlign: TextAlign.center,
                          style: TextStyleUtil.k16Semibold(fontSize: 16.kh),
                        ).paddingOnly(bottom: 4.kh),
                        Text(
                          LocaleKeys.app_theMatchingRideAlertWillBeSentToYouShortly.tr,
                          textAlign: TextAlign.center,
                          style: TextStyleUtil.k16Semibold(fontSize: 16.kh),
