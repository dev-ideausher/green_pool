    ...
    return Scaffold(
      ...
      body: Obx(
        () => controller.myRidesModelData == null
            ...
            // : controller.myRideDetailsModel.value.data!.isEmpty
            //     ? Center(
            //         child:
            //             Text(controller.myRideDetailsModel.value.message ?? ""))
            : Column(
                ...
                children: [
                  ...
                  Expanded(
                      child: controller.myRidesModelData.value.riders?.length ==
                              0
                          ? Center(
                              child: Text(
                          ...
                          : ListView.builder(
                              itemCount: controller
                                  .myRidesModelData.value.riders?.length,
                                            ...
                                            child: ClipOval(
                                              child: SizedBox.fromSize(
                                                ...
                                                child: controller
                                                    ...
                                                    : Image(
                                                        image: NetworkImage(
                                                            "${controller.myRidesModelData.value.riders?[0]?.profilePic?.url}"),
                                                      ),
                                              ),
                                            ),
                                          ).paddingOnly(right: 8.kw),
                                          Text(
                                            "${controller.myRidesModelData.value.riders?[0]?.fullName}",
                                            style: TextStyleUtil.k14Semibold(),
                                          )
                                        ],
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                'DATA NEEDED',
                                                // '${controller.myRidesModelData.value.riders?[0]?.}',
                                                style: TextStyleUtil.k14Regular(
                                                    color: ColorUtil.kBlack02),
