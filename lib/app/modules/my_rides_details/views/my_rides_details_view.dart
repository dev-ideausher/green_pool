                ...
                child: Column(
                  ...
                  children: [
                    ...
                    (controller.myRidesModelData.value.driverBookingDetails?.riders?.length ?? 0) == 0
                        ...
                        : SizedBox(
                            height: ((controller.myRidesModelData.value.driverBookingDetails?.riderBookingDetails?.length??0)* 122.kh),
                            child: ListView.builder(
                                itemCount: controller.myRidesModelData.value.driverBookingDetails?.riderBookingDetails?.length??0,
                                physics: const NeverScrollableScrollPhysics(),
                                itemBuilder: (context, index1) {
                                  final rider = controller.myRidesModelData.value.driverBookingDetails?.riderBookingDetails?[index1];
                                  return Container(
                                    child: Column(
                                      children: [
                                        Row(
                                            ...
                                            Container(
                                              ...
                                              child: ClipOval(
                                                child: SizedBox.fromSize(
                                                  ...
                                                  child: CommonImageView(url: "${rider?.riderDetails?.profilePic?.url ?? ""}"),
                                                ),
                                              ),
                                            ).paddingOnly(right: 8.kw),
                                            Text(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: SizedBox(
                            height: 64.kh,
                            width: 64.kw,
                            child: CommonImageView(url:(controller.myRidesModelData.value.driverDetails?.vehicleDetails?.vehiclePic?.url ?? "")).paddingOnly(right: 8.kw),
                          ),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Wrap(
                      children: [Text(controller.myRidesModelData.value.driverBookingDetails?.description ?? "NA")],
                    ),
                    (controller.myRidesModelData.value.driverBookingDetails?.isStarted ?? false)
                        ? GreenPoolButton(label: Strings.viewDetails, onPressed: () => controller.viewOnMap()).paddingSymmetric(vertical: 40.kh)
                        : GreenPoolButton(label: Strings.viewMatchingRiders, onPressed: () => controller.viewMatchingRiders()).paddingSymmetric(vertical: 40.kh),
                    Visibility(
                      visible: controller.myRidesModelData.value.driverBookingDetails?.riders?.isNotEmpty ?? false,
                        child: InkWell(
